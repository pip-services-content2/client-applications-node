...
exports.ApplicationsDirectClientV1 = void 0;
const pip_services3_commons_nodex_1 = require("pip-services3-commons-nodex");
const pip_services3_rpc_nodex_1 = require("pip-services3-rpc-nodex");
class ApplicationsDirectClientV1 extends pip_services3_rpc_nodex_1.DirectClient {
    constructor() {
        super();
        this._dependencyResolver.put('controller', new pip_services3_commons_nodex_1.Descriptor("service-applications", "controller", "*", "*", "*"));
    }
    getApplications(correlationId, filter, paging) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this._controller.getApplications(correlationId, filter, paging);
            }
            catch (err) {
    ...
    getApplicationById(correlationId, applicationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this._controller.getApplicationById(correlationId, applicationId);
            }
            catch (err) {
                timing.endFailure(err);
                throw err;
    ...
    createApplication(correlationId, application) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this._controller.createApplication(correlationId, application);
            }
            catch (err) {
                timing.endFailure(err);
                throw err;
    ...
    updateApplication(correlationId, application) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this._controller.updateApplication(correlationId, application);
            }
            catch (err) {
                timing.endFailure(err);
                throw err;
    ...
    deleteApplicationById(correlationId, applicationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this._controller.deleteApplicationById(correlationId, applicationId);
            }
            catch (err) {
                timing.endFailure(err);
                throw err;
